textcraft: textcraft.o peasant.o move.o command.o entity.o map.o list.o point.o
	gcc -ggdb -o textcraft textcraft.o peasant.o move.o command.o entity.o map.o list.o point.o -lncurses
